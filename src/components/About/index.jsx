      ...
      <div className="flex w-2/3">
        ...
        <div className="w-full">
          <p>
            ...
            in responsive web design, mobile-first development, and
            cross-browser compatibility. They excel in API integration, CI/CD,
            and web application security while focusing on scalable solutions
            and server-side rendering for improved SEO. With a proactive,
            self-motivated work ethic, I consistently update my skills to
            deliver cutting-edge digital solutions that align with business
            goals.
          </p>
        </div>
      </div>
